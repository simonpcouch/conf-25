...
:::
::: {.column}
(i.e. prompt engineering, fine-tuning, ...)
:::
:::
...
![](figures/bear/whack-a-mole.png){.absolute width=390.5px height=220px left=535px top=220px}
...
![](figures/hexes/vitals.png){.absolute width=204.439px left=535px top=200px}
