...
![](figures/bear/whack-a-mole.png){.absolute width=390.5px height=220px left=430px top=150px}
...
![](figures/hexes/vitals.png){.absolute width=204.439px left=430px top=150px}
...
htmltools::tags$iframe(
  ...
  width = "100%", 
  height = "550px",
  style = "border-radius: 10px; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.3); margin: 0 auto 15px auto; display: block;"
)
```
